...
public class Sprite {
    ...
    public static final Sprite ABAJO0 =new Sprite(16,0,0,0,HojaSprites.jugador);  
    public static final Sprite ABAJO1 =new Sprite(16,1,0,0,HojaSprites.jugador);
    public static final Sprite ABAJO2 =new Sprite(16,2,0,0,HojaSprites.jugador); 
    public static final Sprite ABAJO3 =new Sprite(16,3,0,0,HojaSprites.jugador);
    
    public static final Sprite IZQUIERDA0 =new Sprite(16,0,1,0,HojaSprites.jugador); 
    public static final Sprite IZQUIERDA1 =new Sprite(16,1,1,0,HojaSprites.jugador); 
    public static final Sprite IZQUIERDA2 =new Sprite(16,2,1,0,HojaSprites.jugador);
    public static final Sprite IZQUIERDA3 =new Sprite(16,3,1,0,HojaSprites.jugador); 
    
    public static final Sprite DERECHA0 =new Sprite(16,0,2,0,HojaSprites.jugador); 
    public static final Sprite DERECHA1 =new Sprite(16,1,2,0,HojaSprites.jugador);
    public static final Sprite DERECHA2 =new Sprite(16,2,2,0,HojaSprites.jugador);
    public static final Sprite DERECHA3 =new Sprite(16,3,2,0,HojaSprites.jugador);
    
    public static final Sprite ARRIBA0 =new Sprite(16,0,3,0,HojaSprites.jugador);
    public static final Sprite ARRIBA1 =new Sprite(16,1,3,0,HojaSprites.jugador);
    public static final Sprite ARRIBA2 =new Sprite(16,2,3,0,HojaSprites.jugador);
    public static final Sprite ARRIBA3 =new Sprite(16,3,3,0,HojaSprites.jugador);
    //fin de la coleccion
